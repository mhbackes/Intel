...
; fim da carga inicial dos registradores de segmento
		...
		lea 	dx,nome_dic
		call	conta_l				; conta o numero de linhas validas
		jnc		abriu_dic			; se houve erro encerra o programa
		jmp		fim
abriu_dic:
		lea		dx,msg2
		call	puts
...
abriu_cif:							
		...
		lea		dx,nome_dic			; abre o arquivo dicionario
		call	fopen
		mov		handler_dic,ax
...
laco2:
		...
		mov		bx,handler_dic		; vai para o inicio do arquivo dicionario
		call	fseek_ini
laco3:
		cmp		k,0					; se nao houver linhas do arquivo para serem lidas
		jnz		arq_dic_nao_terminou
		jmp		incrementa_a_b		; vai para incrementa a b e testa nova decifragem
arq_dic_nao_terminou:
		mov		bx,handler_dic		; le linha do arquivo dicionario
...
eh_treze:
		...
		jmp		laco2
achou?:
		cmp		achou,0				; imprime nao encontrado: <texto decifrado>
		je		achou?_nao			; se o programa nao encontrou decifragem
		jmp		laco1
achou?_nao:
		lea		dx,nao_achou
		call	puts
